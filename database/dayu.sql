...
Source Database       : dayu

Target Server Type    : MYSQL
Target Server Version : 50540
File Encoding         : 65001

Date: 2017-09-17 13:59:50
*/
...
CREATE TABLE `cmf_posts` (
  ...
  `is_banner` tinyint(1) DEFAULT '0' COMMENT '是否是banner',
  `fromKey` varchar(20) DEFAULT NULL COMMENT '来源key',
  `fromID` varchar(50) DEFAULT NULL COMMENT '来源唯一标识',
